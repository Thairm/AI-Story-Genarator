                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
                            <a href="mailto:Thairm5719@proton.me" className="flex items-center text-zinc-400 hover:text-white transition-colors">
                                <Mail className="w-4 h-4 mr-2" />
                                Thairm5719@proton.me
                            </a>
                            <a href="tel:+818012178914" className="flex items-center text-zinc-400 hover:text-white transition-colors">
